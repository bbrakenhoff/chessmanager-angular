...
export class TestDataFactory {
  ...
  static createTestCollection(): TestCollection {
    ...
    const startingPosition = FenPosition.create();
    ...
    const foolsMate = FenPosition.create();
  ...
  static createProblemsCollection(): TestCollection {
    ...
    const problem1 = FenPosition.create();
    ...
    const problem2 = FenPosition.create();
    ...
    const problem3 = FenPosition.create();
    ...
    const problem4 = FenPosition.create();
    ...
    const problem5 = FenPosition.create();
    ...
    const problem6 = FenPosition.create();
  ...
  static createErrorsCollection(): TestCollection {
    ...
    const tooManyPiecesOnRank = FenPosition.create();
    ...
    const tooManyEmptySquaresToRank = FenPosition.create();
    ...
    const notEnoughSquaresOnRank = FenPosition.create();
    ...
    const tooManyRanksDefined = FenPosition.create();
    ...
    const illegalCharacterFound = FenPosition.create();
    ...
    const notEnoughSquaresDefined = FenPosition.create();
